...
my_df_1%>%
  ...
  theme(panel.background = element_rect(fill = 'white'),
        ...
        axis.line.x = element_blank(),
        axis.line.y = element_line(linetype = 'solid'), 
        axis.title.x = element_text(hjust=1, face = 'bold', margin = margin(t = 10, b = 12), size = 9),
        axis.text.y = element_text(size = 6),
        axis.text.x = element_text(size = 10, face = 'bold'),
        axis.title.y = element_text(vjust = 1.05, face = 'bold', angle = 0, margin = margin(t=0,b=0,l=20,r=-46), size =9),
        legend.position = 'none')+
  scale_fill_gradient(low = '#FFCC66', high = '#CC0000')+
  scale_x_discrete(labels = c('Aitoloakarnia', 'Argolida','Arcadia','Arta','Attica','Achaia','Viotia','Grevena','Drama','Dodekanisswn','Evros','Evia','Evritania',
                             'Zakinthos','Ilia','Imathia','Iraklio','Thespotia','Thessaloniki','Ioannina','Kavala','Karditsa','Kastoria','Kerkira','Kefallonia',
                             'Kilkis','Kozani','Korinthia','Kiklades','Lakonia','Larisa','Lasithiou','Lesvos','Lefkada','Magnhsia','Messinia','Xanthi','Pella','Pieria',
                             'Preveza','Rethimno','Rodopi','Samos','Serres','Trikala','Fthiotida','Florina','Fokida','Chalkidiki','Chania','Chios'))+
  coord_flip()
...
dev.size("in")
ggsave('ggtest.png', plot_55, width =  4.3, height = 6.7, dpi = 1200)
...
acres_burnt_per_year%>%
  ...
  theme(panel.background = element_rect(fill = 'white'),
        ...
        axis.title.x = element_text(size = 9, margin = margin(t = 5, r = 0, b = 0, l = 20), hjust = 1,
                                    face = 'bold'),
...
plot_55 = 
money %>%
  filter((Authority == 'APD-MT') | (Authority =='APD-AIGAIOU')| (Authority =='APD-THEST')| (Authority =='APD-DEPIN')| (Authority =='APD-ATTIKH')| (Authority =='APD-HPDM'))%>%
  ggplot(aes(x = Year, y = Amount1/10^6,colour = Authority,group = Authority))+
  geom_hline(yintercept = seq(5,25,5), colour = 'grey')+
  geom_line(size = 2)+
  theme(panel.background = element_rect(fill = 'white'),
        panel.spacing= margin(b = 10),
        panel.border = element_rect(colour = 'black', fill = 'transparent', size = 2),
        plot.background = element_rect(color = 'black'),
        plot.title = element_text(face = 'bold', hjust = 0.5, margin = margin(b = 0,t = 0), size = 12),
        plot.subtitle = element_text(face = 'italic', hjust = 0.5, margin = margin(t=5, b= 25), size =8 ),
        plot.caption = element_text(face = 'italic', size = 6),
        axis.title.y = element_text(face = 'bold',angle = 0 , vjust =0.95 , margin = margin(r = -90, l= 35)),
        axis.text.y = element_text(size = 11, face = 'bold'),
        axis.title.x = element_text(margin = margin(t = 10), face = 'bold', hjust = 1, size = 9),
        axis.text.x = element_text(face = 'bold', angle = 90, size = 10),
        legend.title = element_text(face = 'bold', size = 9),
        legend.background = element_rect(fill = 'white'), 
        legend.key = element_rect(fill = 'transparent'))+
  labs(title = 'Funding of Decentralised Administration',subtitle = 'in Greece between 2017 and 2022*',
       y = '???, in millions', caption = 'Source: apdattikh.gr,apd-depin.gr,m-t.gov.gr\napdthest.gr,apdaigaiou.gr,apdhp-dm.gr', fill = 'Authority*')+
  scale_y_continuous(breaks = seq(5,25,5), limits = c(0,30))+
  scale_color_manual(values = c('black', 'darkgreen','yellow', 'red4', 'firebrick','lightgrey'),
                     labels = c("Aegean Isl.", "Attica", "West Greece-Peloponnese-\nIonian Isl.","Epirus-West Macedonia","Macedonia-Thrace","Thessaly-Central Greece"), 
                     name = 'Dec.\nAdministration')

plot_55
dev.size("in")
ggsave("ggtest.png",plot_55, height = 3.9, width = 6.2, dpi = 800)

plot_77 = 
  money %>%
  filter(Authority == 'T_PY_S')%>%
  ggplot(aes(x = Year, y = Amount1/10^6))+
  geom_hline(yintercept = seq(400,500,50), colour = 'grey')+
  geom_line(size = 2, group = 1, colour = 'red2')+
  theme(panel.background = element_rect(fill = 'white'),
        panel.spacing= margin(b = 10),
        panel.border = element_rect(colour = 'black', fill = 'transparent', size = 2),
        plot.background = element_rect(color = 'black'),
        plot.title = element_text(face = 'bold', hjust = 0.5, margin = margin(b = 0,t = 0), size = 12),
        plot.subtitle = element_text(face = 'italic', hjust = 0.5, margin = margin(t=5, b= 15), size =8),
        plot.caption = element_text(face = 'italic', size = 6),
        axis.title.y = element_text(face = 'bold',angle = 0 , vjust =0.94 , margin = margin(r = -102, l= 38), size = 12),
        axis.text.y = element_text(size = 11, face = 'bold'),
        axis.title.x = element_text(margin = margin(t = 10), face = 'bold', hjust = 1, size = 9),
        axis.text.x = element_text(face = 'bold', angle = 90, size = 11),
        legend.title = element_text(face = 'bold', size = 9),
        legend.background = element_rect(fill = 'white'), 
        legend.key = element_rect(fill = 'transparent'))+
  labs(title = 'Funding of Fire Service',subtitle = 'in Greece between 2017 and 2022',
       y = '???, in millions', caption = 'Source: fireservice.gr', fill = 'Authority*')+
  scale_y_continuous(breaks = seq(400,500,50), limits = c(375,525))

plot_77
dev.size("in")
ggsave("ggtest.png",plot_77, height = 4.2, width = 4.2, dpi = 800)
...
nice%>%
  ...
  labs(title = 'Rate of change in Funding per year', subtitle = 'since 2018',
       y = 'Change (%)', 
       x="Year",caption = "Source: firesercvice.gr,apdattikh.gr,apd-depin.gr,\napdthest.gr,apdaigaiou.gr,apdhp-dm.gr,m-t.gov.gr ")+
...
nice_1%>%
  ggplot(aes(x = year, y = change*100, fill = authority ))+
  geom_col(width = 0.2)+
  scale_fill_manual(values = c('darkgreen', 'red2'), labels = c("D.A*", "F.S**"))+
  geom_hline(yintercept=0, color = 'black', linetype = 'solid' , size = 1)+
  theme(panel.background = element_rect(fill = 'white'),
  ...
  labs(title = 'Rate of change in Funding per year', subtitle = 'in Greece since 2018',
       y = 'Change (%)', 
       x="Year",caption = "D.A*: Decentralised Administration (in fact their Forest Departments)\nF.S**: Fire Service\n
       Source: firesercvice.gr,apdattikh.gr,apd-depin.gr,m-t.gov.gr\napdthest.gr,apdaigaiou.gr,apdhp-dm.gr")+
  scale_y_continuous(breaks = c(-5, 0,5,10))+
  coord_flip()
plot_66
dev.size("in")
ggsave("ggtest.png",plot_66, height = 3.8, width = 5.5, dpi = 1200)
